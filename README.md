# COVID-19-Utility-Web-Application v1.6.1 (Beta) (Now in Beta!!)
...
- **COVID-19-Utility-Web-Application v1.6.1 (Beta) can run (localized) through your IDE or accessed via the Streamlit webpage.**
...
# Streamlit Webpage ---> [COVID-19-Utility-Web-Application v1.6.1 (Beta)](https://ariankharazmi-covid-19-utility-web-application-main-xlxt4l.streamlit.app/)

* ## Web View: v1.6.1 (Beta)
