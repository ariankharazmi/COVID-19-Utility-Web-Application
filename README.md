# COVID-19-Utility-Web-Application v1.4.5 (Alpha) 
...
- **COVID-19-Utility-Web-Application v1.4.5 (Alpha) can run through your IDE (v1.4.5) or accessed via the Streamlit webpage. (v1.4.5)**
