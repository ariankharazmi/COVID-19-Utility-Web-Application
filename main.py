...
##Code for creating new Window
##window=tk.Tk()
##window.title("Coronavirus Utility")
##window.geometry("600x400")
##newlabel = tk.Label(text = " Coronavirus (COVID-19) Utility ")
##newlabel.grid(column=0,row=0)
##window.mainloop()

st.title('COVID-19 Utility Webpage')
st.markdown("""
* **Python libraries:** urllib3, numpy, tkinter, streamlit
